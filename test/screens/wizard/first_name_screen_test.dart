...
void main() {
  group('FirstNameScreen', () {
    ...
    testWidgets('has screen:onboarding-first-name semantics label', (tester) async {
      await tester.pumpWidget(buildOnboardingTestHarness(
        screen: const FirstNameScreen(),
        routeName: route,
      ));
      await tester.pumpAndSettle();
      expect(
        find.byWidgetPredicate((w) => w is Semantics && (w as Semantics).properties.label == 'screen:onboarding-first-name'),
        findsOneWidget,
      );
    });
  });
